...
#include "SecondOrderActuator.generated.h"

UCLASS()
class SKYPHYS_API USecondOrderActuator : public UActuatorModel
{
	GENERATED_BODY()

public:
	USecondOrderActuator();
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "Actuator Parameters", Meta = (Tooltip = "Damping ratio of the filter (unitless)"))
	float zeta = 0.0f;
